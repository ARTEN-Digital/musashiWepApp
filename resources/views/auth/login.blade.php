        ...
        <div class="flex items-center w-full max-w-md px-6 mx-auto lg:w-2/6">
            <div class="flex-1">
                <div class="text-center">
                    ...
                    <img class="mx-auto" src="/imgs/logos/logo.png" alt="">
                </div>
                    ...
                    <form method="POST" action="{{ route('login') }}">
                        ...
                        <div class="mt-6">
                            <div class="flex justify-between mb-2">
                                ...
                                <a href="#" class="text-sm text-gray-400 focus:text-blue-500 hover:text-blue-500 hover:underline">¿Olvisaste tu contraseña?</a>
                            </div>

                            <input type="password" name="password" id="password" placeholder="Tu contraseña" type="password" name="password" required autocomplete="current-password" class="inputText " />
                        </div>
