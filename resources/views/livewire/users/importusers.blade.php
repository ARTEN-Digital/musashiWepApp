<div>
    ...
    <div id="divimport1" class="w-full">
        ...
        <label class="block">
            <input wire:model.defer="archivedata" type="file" accept=".csv" class="block w-10/12 mx-auto text-xs text-gray-500 file:me-4 file:py-2 file:px-4 file:rounded-lg file:border-0 file:text-sm file:font-semibold file:bg-blue-500  file:text-white hover:file:bg-blue-500 file:disabled:opacity-50 file:disabled:pointer-events-none file:text-sm">
        </label>
        <div class="w-1/3 mx-auto">
            <button wire:click="uploadcvs" class="w-full mt-8 p-2 bg-neutral-400 hover:bg-neutral-500 text-white rounded-lg font-semibold">Cargar</button>
        </div>
    ...
    <div id="divimport2" class="rounded hidden">
        ...
        <button wire:click="uploadusers" class="w-fit mx-auto my-2 py-2 px-3 bg-neutral-400 hover:bg-neutral-500 text-white rounded-lg flex">
        ...
        <div class="mx-4">
            <div class="flex my-3">
                ...
                <p class="text-xs text-justify">Los datos importados sobrescribirán los actuales. Si hay usuarios que esten desactivados y aparcen en esta lista seran activados.</p>
            </div>
