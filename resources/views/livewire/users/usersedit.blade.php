<div>
    ...
    <div class="flex">
        <p class="text-2xl font-bold mb-3 my-2">Editar usuario</p>
        <button onclick="closeeditusers()" class="bg-neutral-400 hover:bg-neutral-500 p-1 rounded-lg w-fit ml-auto my-2">
