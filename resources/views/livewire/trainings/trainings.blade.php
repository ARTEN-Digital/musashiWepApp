<div>
    <div class="flex">
                            ...
                            <table class="min-w-full divide-y">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr>
                                        ...
                                        <td class="px-4 py-4">
                                            <button onclick="showedittrainings()" class="bg-cyan-700 p-2 rounded-lg mx-2"> 
        ...
        <div id="divcreatetrainings" class="w-38p hidden ml-auto p-5 bg-white rounded shadow-lg">
            <livewire:trainings.trainingscreate/>
        </div>

        <div id="divedittrainings" class="w-38p hidden ml-auto p-5 bg-white rounded shadow-lg">
