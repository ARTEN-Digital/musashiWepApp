<div>
    <div class="flex">
                                ...
                                <tbody class="bg-white divide-y divide-gray-200">
                                    <tr>
                                       ...
                                       <td class="px-4 py-4">
                                        ...
                                        <td class="px-4 py-4">
                                            Lorem ipsum dolor sit amet consectetur adipisicing elit. Aspernatur recusandae laborum modi error accusamus autem cum neque atque architecto ex unde veritatis, expedita reprehenderit? Delectus, accusamus fuga. Minus, exercitationem aspernatur?
                                        </td>
                                        <td class="px-4 py-4">
                                            Hilario Ojeda
                                       </td>
                                        <td class="px-4 py-4 flex">
                                            <button onclick="showcreatetopics()" class="bg-cyan-700 p-2 rounded-lg mx-2"> 
        ...
        <div id="divcreatetopics" class="w-38p hidden ml-auto p-5 bg-white rounded shadow-lg">
