<div>
    <div class="flex">
        <div id="divareas" class="w-full p-5 rounded">
            ...
            <div class="overflow-y-auto px-3" style="height: 68vh">

                <div class="flex flex-col bg-white p-4 rounded-lg w-full my-6 shadow-lg">
                    <div class="my-3 flex">
                        <p class="text-2xl my-2">Área 1</p>
                        <div class="flex ml-auto">
                            ...
                            <button onclick="showcreateprocess()" class="w-fit mr-3 my-2 py-2 px-3 bg-neutral-400 hover:bg-neutral-500 text-white rounded-lg flex">
                                <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-6 h-6 mr-2">
                                    <path stroke-linecap="round" stroke-linejoin="round" d="M12 9v6m3-3H9m12 0a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z" />
                                </svg>                                                                   
                                Nuevo proceso
                    ...
                    <table class="divide-y overflow-y-auto">
                        <thead class="bg-neutral-400 text-white">
                            <tr>
                                <th scope="col" class="py-4 px-4 text-sm font-normal text-left rtl:text-right">ID</th>
                                <th scope="col" class="py-4 px-4 text-sm font-normal text-left rtl:text-right">Proceso</th>
                                <th scope="col" class="py-4 px-4 text-sm font-normal text-left rtl:text-right">Actividad</th>
                        ...
                        <tbody class="bg-white divide-y divide-gray-200">
                            <tr>
                                ...
                                <td class="px-4 py-4">
                                    <button onclick="showeditprocess()" class="bg-cyan-700 p-2 rounded-lg mx-2"> 
                ...
                <div class="flex flex-col bg-white p-4 rounded-lg w-full my-6 shadow-lg">
                    <div class="my-3 flex">
                        <p class="text-2xl my-2">Área 2</p>
                        <div class="flex ml-auto">
                            <button onclick="showcreatearea()" class="w-fit mr-3 my-2 py-2 px-3 bg-neutral-400 hover:bg-neutral-500 text-white rounded-lg flex">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 mr-2">
                                    <path d="M21.731 2.269a2.625 2.625 0 00-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 000-3.712zM19.513 8.199l-3.712-3.712-8.4 8.4a5.25 5.25 0 00-1.32 2.214l-.8 2.685a.75.75 0 00.933.933l2.685-.8a5.25 5.25 0 002.214-1.32l8.4-8.4z" />
                ...
                <div class="flex flex-col bg-white p-4 rounded-lg w-full my-6 shadow-lg">
                    <div class="my-3 flex">
                        <p class="text-2xl my-2">Área 3</p>
                        <div class="flex ml-auto">
                            <button onclick="showcreatearea()" class="w-fit mr-3 my-2 py-2 px-3 bg-neutral-400 hover:bg-neutral-500 text-white rounded-lg flex">
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-6 h-6 mr-2">
                                    <path d="M21.731 2.269a2.625 2.625 0 00-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 000-3.712zM19.513 8.199l-3.712-3.712-8.4 8.4a5.25 5.25 0 00-1.32 2.214l-.8 2.685a.75.75 0 00.933.933l2.685-.8a5.25 5.25 0 002.214-1.32l8.4-8.4z" />
        ...
        <div id="divcreatearea" class="w-38p hidden ml-auto p-8 bg-white rounded shadow-lg">
            <livewire:areasprocess.areacreate/>
        </div>

        <div id="divcreateprocess" class="w-38p hidden ml-auto p-8 bg-white rounded shadow-lg">
            <livewire:areasprocess.processcreate/>
        </div>

        <div id="diveditprocess" class="w-38p hidden ml-auto p-8 bg-white rounded shadow-lg">
