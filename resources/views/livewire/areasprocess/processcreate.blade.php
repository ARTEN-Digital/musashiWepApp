<div>
    ...
    <div class="flex">
        <p class="text-2xl font-bold mb-3 my-2">Crear proceso</p>
        <button onclick="closecreateprocess()" class="bg-neutral-400 hover:bg-neutral-500 p-1 rounded-lg w-fit ml-auto my-2">
